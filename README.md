...
To make a valid WebGL program you need to:
- create shaders
- link the program
- draw
...
Usually the drawing depends on the data provided to the Vertex shader. In our simple version of Vertex shader we can only draw a static point in the middle of our canvas.
